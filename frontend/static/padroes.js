...
const PADROES_IGNORADOS = new Set(["titulo", "data_postagem", "hora_postagem", "roteiro", "imagens_base", "base_restante", "num_cenas", "som_fundo_playlist", "som_fundo_biblioteca", "em_branco", "descricao_youtube"]);
